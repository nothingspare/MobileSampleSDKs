...
public class APIController {
    ...
    public Future<CustomersModel> GetCustomersAsync (
        ...
        APIHelper.appendUrlWithQueryParameters(queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5128055870995132776L;
            {
                    put( "filter", filter );
            }});
    ...
    public Future<CustomersModel> GetOneCustomersAsync (
        ...
        APIHelper.appendUrlWithTemplateParameters(queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5301990517298604365L;
            {
                    put( "pk", pk );
            }});
    ...
    public Future<CustomersModel> putUpdateOneCustomersAsync (
        ...
        //process optional query parameters
        APIHelper.appendUrlWithTemplateParameters(queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4870450108906434504L;
            {
                    put( "pk", pk );
            }});
    ...
    public Future<CustomersModel> DeleteOneCustomersAsync (
        ...
        //process optional query parameters
        APIHelper.appendUrlWithTemplateParameters(queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5595911055635617609L;
            {
                    put( "pk", pk );
            }});
